<template lang="pug">
.welcome-container
  .title.t-primary.ml-8.t-bold Bienvenue {{partnerName}}
  //-.page
...
export default {
  ...
  computed: {
    ...
    partnerName() { return this.$api.data.partners?.[this.partnerId]?.name || ''; }
  },
  methods: { updateSelectedCategory(category) { this.selectedSolutionCategory = category; }, }
}
</script>
